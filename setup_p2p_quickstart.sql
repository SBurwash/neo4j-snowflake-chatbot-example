...
GRANT ROLE gds_user_role TO USER STEPHANE;
...
GRANT CREATE STREAMLIT ON SCHEMA STEPHANE_SANDBOX.PUBLIC TO ROLE gds_user_role;
GRANT CREATE STAGE ON SCHEMA STEPHANE_SANDBOX.PUBLIC TO ROLE gds_user_role;
